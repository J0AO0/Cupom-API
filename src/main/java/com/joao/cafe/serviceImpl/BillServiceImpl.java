...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        log.info("dentro do generateReport");
        try{
            String fileName;
            if(validateRequestMap(requestMap)){
                ...
                PdfWriter.getInstance(document, new FileOutputStream(CafeConstants.STORED_LOCATION+"\\"+fileName+".pdf"));
                ...
                +"Obrigado por visitar. Volte sempre !!",getFont("Data"));
                document.add(footer);
                document.close();
                return new ResponseEntity<>("{\"uuid\":\""+fileName+"\"}",HttpStatus.OK);

            }
            return CafeUtils.getResponseEntity("Os dados solicitados não foram encontrados", HttpStatus.BAD_REQUEST);
        }catch(Exception ex){
            ex.printStackTrace();
        }
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        log.info("getPdf : requestMap {}", requestMap);
        try{
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try{
            ...
            if(!optional.isEmpty()) {
                ...
                return CafeUtils.getResponseEntity("Conta deletada com sucesso", HttpStatus.OK);
            }
            return CafeUtils.getResponseEntity("O número dessa conta não existe.", HttpStatus.OK);
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return CafeUtils.getResponseEntity(CafeConstants.SOMETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
